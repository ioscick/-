...
//        [self.centerImageView addGestureRecognizer:tapGesture];
...
//    [self.delegate viewPull:currentImage];
}
//- (void)tapItem:(UIImageView *)sender
//{
//    
//}
...
//    _rightImageView.image = [UIImage imageNamed:_imageNameArray[2]];
    ...
    [_leftImageView sd_setImageWithURL:_imageNameArray[count - 1]];
    [_centerImageView sd_setImageWithURL:_imageNameArray[0]];
    [_rightImageView sd_setImageWithURL:_imageNameArray[1]];
}
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    {
        _pageControl.frame = CGRectMake(10, UISCREENHEIGHT - 20, 20*_pageControl.numberOfPages, 20);
    }
...
//        [_leftImageView sd_setImageWithURL:_imageNameArray[count - 1]];
    ...
    if (currentImage == 0)
    {
        ...
        [_leftImageView sd_setImageWithURL:_imageNameArray[(count-1)%_imageNameArray.count]];
        ...
        [_centerImageView sd_setImageWithURL:_imageNameArray[currentImage%_imageNameArray.count]];
        ...
        [_rightImageView sd_setImageWithURL:_imageNameArray[(currentImage+1)%_imageNameArray.count]];
    ...
    {
        //    _leftImageView.image = [UIImage imageNamed:_imageNameArray[(currentImage-1)%_imageNameArray.count]];
        [_leftImageView sd_setImageWithURL:_imageNameArray[(currentImage-1)%_imageNameArray.count]];
